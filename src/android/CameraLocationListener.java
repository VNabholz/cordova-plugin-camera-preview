...
public class CameraLocationListener implements LocationListener {
    ...
    private CameraLocationServices mOwner;
    private List<CallbackContext> mCallbacks = new ArrayList<CallbackContext>();
    private Timer mTimer = null;
    private String TAG;

    public CameraLocationListener(GoogleApiClient client,
                                  CameraLocationServices broker, String tag) {
    ...
    private class LocationTimeoutTask extends TimerTask {
        ...
        private CameraLocationListener mListener = null;

        public LocationTimeoutTask(CallbackContext callbackContext,
                                   CameraLocationListener listener) {
